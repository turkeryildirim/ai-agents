...
**Scopes:**
1. **Global Memory (User Scope):** `~/.gemini/memory/claude/` (Rules applying to all projects, e.g., standard CLI flags).
2. **Project Memory (Project Scope):** `./.gemini/memory/claude/` (Rules specific to the current workspace, e.g., project-specific ignore flags).
